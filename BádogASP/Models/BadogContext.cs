...
public partial class BadogContext : DbContext
{
    public BadogContext()
    {
    }

    public BadogContext(DbContextOptions<BadogContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("User Id=postgres.tujpztlyzzuhrxujhcfb;Password=Csanad2002;Server=aws-0-eu-central-1.pooler.supabase.com;Port=6543;Database=postgres;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderItem>(entity =>
        {
            ...
            entity.Property(e => e.Subtotal)
                .HasPrecision(10, 2)
                .HasComputedColumnSql("((quantity)::numeric * price_per_unit)", true)
        ...
        modelBuilder.Entity<Shipping>(entity =>
        {
            ...
            entity.HasIndex(e => e.TrackingNumber, "shipping_tracking_number_key").IsUnique();
